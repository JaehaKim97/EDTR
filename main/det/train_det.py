...
from utils.detection import (
    GroupedBatchSampler, CocoEvaluator, draw_box, collate_fn,
     create_aspect_ratio_groups, get_coco_api_from_dataset, _get_iou_types
)
...
def main(args) -> None:
    ...
    while global_step < max_steps:
        ...
        for gt_list, lq_list, annot_list, path_list in loader:
            ...
            # for idx in range(16):
            #     gt_box = draw_box(gt_list[idx], annot_list[idx])
                ...
                for idx, (val_gt_list, val_lq_list, val_annot_list, _) in enumerate(val_loader):
                    ...
                    with torch.no_grad():
                        ...
                        if idx < 5 and accelerator.is_local_main_process:
                            ...
                            val_pred_box = draw_box(val_inp_list[0], val_pred_list[0])
